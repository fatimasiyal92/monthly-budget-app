...
<center>
    ...
    <div class="container">
        <h1 class="heading">Create New Transaction</h1>
        <form:form method="POST"  class="form-group" action="${pageContext.request.contextPath}/saveTransaction.html">
        <table class="table table-striped tab-content" style="border: dot-dash">
            <tr>
                <td><form:label path="id">ID:</form:label></td>
                <td><form:input path="id" class="form-control"  value="${transaction.id}" readonly="true"/></td>
            </tr>
            <tr>
                <td><form:label path="name">Name:</form:label></td>
                <td><form:input path="name" class="form-control" value="${transaction.name}"/></td>
            </tr>
            <tr>
                <td><form:label path="description">Description:</form:label></td>
                <td><form:input path="description" class="form-control" value="${transaction.description}"/></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
        ...
        <table class="table table-striped tab-content" style="border: dot-dash" align="center" border="1">
            ...
            <tr>
                ...
                <th scope="col" class="table-header title">Description</th>
            ...
            <c:forEach items="${transactions}" var="transaction" varStatus="loop">
                ...
                <tr>
                        <%--<td>${loop.index + 1}</td>--%>
                    <td scope="row" class="${str}"><c:out value="${transaction.id}"/></td>
                    <td scope="row" class="${str}"><c:out value="${transaction.name}"/></td>
                    <td scope="row" class="${str}"><c:out value="${transaction.description}"/></td>
                    <td scope="row" class="${str}" align="center"><a href="${pageContext.request.contextPath}/editTransaction.html?transactionId=${transaction.id}">Edit</a> | <a
                            href="${pageContext.request.contextPath}/deleteTransaction.html?transactionId=${transaction.id}">Delete</a></td>
                </tr>
                <%
                    i++;
                %>
