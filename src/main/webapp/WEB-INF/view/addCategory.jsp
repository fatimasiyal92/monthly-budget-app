...
<center>
    ...
    <div class="container">
        <h1 class="heading">Create New Category</h1>
        <form:form method="POST"  class="form-group" action="${pageContext.request.contextPath}/saveCategory.html">
        <table class="table table-striped tab-content" style="border: dot-dash">
            <tr>
                <td><form:label path="id">ID:</form:label></td>
                <td><form:input path="id" class="form-control"  value="${category.id}" readonly="true"/></td>
            </tr>
            <tr>
                <td><form:label path="name">Name:</form:label></td>
                <td><form:input path="name" class="form-control" value="${category.name}"/></td>
            </tr>
            <tr>
                <td><form:label path="type.id">Type ID:</form:label></td>
                <td><form:input path="type.id" class="form-control" value="${category.type.id}"/></td>
            </tr>
<%--            <tr>--%>
<%--                <td><form:label path="category.id">Category ID:</form:label></td>--%>
<%--                <td><form:input path="category.id" class="form-control" value="${category.category.id}"/></td>--%>
<%--            </tr>--%>
            <tr>
                <td>&nbsp;</td>
        ...
        <table class="table table-striped tab-content" style="border: dot-dash" align="center" border="1">
            ...
            <tr>
                ...
                <th scope="col" class="table-header title">Name</th>
                <th scope="col" class="table-header title">Type ID</th>
            ...
            <c:forEach items="${categories}" var="category" varStatus="loop">
                ...
                <tr>
                        <%--<td>${loop.index + 1}</td>--%>
                    <td scope="row" class="${str}"><c:out value="${category.id}"/></td>
                    <td scope="row" class="${str}"><c:out value="${category.name}"/></td>
                    <td scope="row" class="${str}"><c:out value="${category.type.id}"/></td>
                    <td scope="row" class="${str}" align="center"><a href="${pageContext.request.contextPath}/editCategory.html?categoryId=${category.id}">Edit</a> | <a
                            href="${pageContext.request.contextPath}/deleteCategory.html?categoryId=${category.id}">Delete</a></td>
                </tr>
                <%
                    i++;
                %>
